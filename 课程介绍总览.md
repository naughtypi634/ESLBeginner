...
本周我们练习位置与方向介词，了解 in/on/at、into/towards/across 等表示地点与移动的介词，学会用它们说清东西在哪里、人和物往哪里走，弄懂 pass/past、back home 等常见错误，并掌握 on your mind、go through the plan 一类的常用介词短语，应用到指路、通勤、办公室闲聊等场景中。

Weather
本周我们练习天气词汇，掌握 20 个核心天气词及其含义，了解 rainy / sunny / windy / hot / cold 五类天气的常见表达与简单句型，练习描述眼前天气，并应用到穿衣、出行、心情与旅行话题的对话讨论中。

> 说明：目前覆盖所有有 `.md` 源文件的课程（01–07、07-1、07-2、10–24、单一对象描述练习题）。08/09（Relative Clause 系列）是 HTML 源，暂不在此表，如需纳入再补。
